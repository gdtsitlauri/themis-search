...
\section{Conclusion}
THEMIS is already breadth-complete as a research prototype: it integrates sparse retrieval, neural retrieval, typed query processing, multimedia forensics, causal reranking, and formal computation theory into a single reproducible codebase. The most important future extensions are not architectural rewrites, but stronger large-scale evaluation, richer external datasets, and deeper formalization of the causal assumptions.
